...
//console.log(sumEvens([7, 1, 22, 1, 102, 0]))
...
//console.log(reverse([7, 1, 22, 1, 102, 0]));

// 7.Посчитать количество нечетных элементов массива
function sumEvens2(arr) {
  var sum = [];
  for (var k = 0; k < arr.length; k++) {
    if (k % 2 === 0){
      sum.push(arr[k]);
...
console.log(sumEvens2([7, 1, 22, 1, 102, 0]))
...
//console.log(changeHalves([1, 2, 3, 4]));
...
module.exports = { getMinEl, getMaxEl, getMinIndex, getMaxIndex, sumEvens, reverse, sumEvens2, changeHalves, bubble, select, insert }